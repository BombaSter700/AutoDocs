from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QPushButton, 
                           QCheckBox, QComboBox, QSlider, QLabel, QMenu, 
                           QSizePolicy, QApplication)
from PyQt6.QtCore import Qt, QSettings, pyqtSignal
from PyQt6.QtGui import QAction, QKeySequence

class WindowManager(QWidget):
    """Управление настройками окна - масштабирование, полноэкранный режим и т.д."""
    ...
    def setup_ui(self):
        """Настройка интерфейса менеджера окон"""
        ...
        self.scale_combo.currentTextChanged.connect(self.change_scale_combo)
        ...
        scale_layout.addLayout(zoom_layout)
        ...
        window_layout.addWidget(self.fullscreen_btn)
        
        self.normal_btn = QPushButton("⛶ Оконный режим")
        self.normal_btn.clicked.connect(self.normal_screen)
        window_layout.addWidget(self.normal_btn)
    ...
    def update_scale_combo(self):
        """Обновление комбобокса масштаба"""
    ...
    def change_scale_combo(self, scale_text):
        """Изменение масштаба через комбобокс"""
        scale_map = {
            "75%": 0.75,
            "100%": 1.0,
            "125%": 1.25,
    ...
    def zoom_in(self):
        """Увеличение масштаба"""
        new_scale = round(self.current_scale + 0.1, 1)
        self.set_scale(new_scale)
    ...
    def setup_window_shortcuts(self, window):
        """Настройка горячих клавиш для окна"""
